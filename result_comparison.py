...
def read_result_folder(folder, run_name):
    ...
    results[run_name]['dbpedia_10'] = results[run_name].pop('dbpedia_10_total') / results[run_name].pop(
        'dbpedia_10_count')
...
def loop_results():
    ...
    for result_run in range(1, 2):
        run_name = "result_" + str(result_run)
        read_result_folder(dir_path + os.sep + "results_bafrec_esbm", run_name)
